...
# 5 consultas aplicando la operación UNIÓN
...
from prestamo as P
INNER JOIN sucursales on P.nombre_sucursal = sucursales.nombre_sucursal;
...
# 5 consultas aplicando la operación INTERSECCIÓN
...
# 5 consultas aplicando la operación EXCEPT
